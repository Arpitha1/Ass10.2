...
public class MainActivity extends AppCompatActivity implements MyRecyclerAdapter.MyClickListener,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRecycleAdapter=new MyRecyclerAdapter(itemData,this);
